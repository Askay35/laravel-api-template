### QuranReels API — авторизация и архитектура

QuranReels — это пример аккуратно спроектированного REST API на Laravel с продуманной архитектурой (сервисы, репозитории, DTO) и полноценной авторизацией по access / refresh токенам.
